...
<head>
    ...
    <title>TransitPro - Accueil</title>
    <!-- CSS AOS -->
    ...
    <main class="main-content">
        ...
        <header class="dashboard-header" data-aos="fade-in">
            <div class="header-title">
                <h1>Bienvenue sur TransitPro</h1>
                <p>La plateforme logistique intelligente pour la République de Guinée.</p>
            </div>
        </header>
        ...
        <section class="data-section" data-aos="fade-up" data-aos-delay="100">
            <div class="dashboard-grid">
                <div class="dashboard-card card-blue-royal">
                    ...
                    <div class="card-body">
                        <p style="color: var(--color-text-body); font-size: 1rem; line-height: 1.6; margin-top: 10px;">
                            Faciliter et numériser le transit de marchandises en Guinée et à travers l'Afrique de l'Ouest. Nous offrons une visibilité en temps réel sur les expéditions, une facturation automatisée et un suivi précis des opérations logistiques pour tous les acteurs du secteur.
                        </p>
                    </div>
                </div>
                ...
                <div class="dashboard-card card-blue-cyan">
                    <div class="card-header">
                        <h3 class="card-title">Avantages Clés</h3>
                    </div>
                    <div class="card-body">
                        <ul style="color: var(--color-text-body); font-size: 0.95rem; line-height: 1.8; margin-top: 10px; padding-left: 20px;">
                            <li><strong>Suivi en direct</strong> des expéditions et du fret.</li>
                            <li><strong>Génération automatique</strong> des factures (TTC, brut, TVA).</li>
                            <li><strong>Gestion multi-modes</strong> (Terrestre, Aérien, Maritime).</li>
                            <li><strong>Base de données centralisée</strong> pour clients, villes et statistiques.</li>
                        </ul>
                    </div>
                </div>
            </div>
